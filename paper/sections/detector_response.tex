...
We use the \texttt{ASTERIA}~\cite{spencer_griswold_2020_3926835} package in order to simulate the detector response to the different SNe scenarios as well as the thermal and radioactive noise in the DOMs. \yy{we need to provide a brief recasting of simulating the detector response, especially for different flavors.}
