...
Puzzles such as the non-vanishing neutrino mass, the origin of observed matter-antimatter asymmetry, and the nature of dark matter, among others, seek explanations beyond the Standard Model (BSM).
...
Core collapse supernovae (CCSNe) release most of their energy in neutrinos, offering unique opportunities to test BSM physics via neutrino interactions.
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.47\textwidth]{figures/DecayGeometry.pdf}
...
\begin{align}
    \delta t &\simeq L_\phi(\frac{1}{\beta} -1) + L_\phi(1-\cos\alpha) = \frac{8\pi}{3 E_{\nu}g_\phi^2}\,,
    \label{eq:deltat}
\end{align}
...
\begin{figure}[t!]
    ...
    Additionally, we also show the reaches by supernova cooling (blue) and by the lack of observation of high-energy neutrinos from SN1987A (grey). %\cite{Fiorillo:2022cdq}, with the width of the shading region quantifying uncertainties from supernova modeling.
    }
...
We would like to thank Thomas Janka and Daniel Kresse for providing the data from Garching CCSNe simulations (available at \url{https://wwwmpa.mpa-garching.mpg.de/ccsnarchive/}) in machine-readable form, and also for stimulating discussions. Y.-Y. L is supported by the NSF of China through Grant No. 12305107, 12247103.
